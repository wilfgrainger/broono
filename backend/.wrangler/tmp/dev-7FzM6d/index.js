...
// .wrangler/tmp/bundle-8kqjVk/strip-cf-connecting-ip-header.js
...
var require_utils = __commonJS({
  "node_modules/qs/lib/utils.js"(exports, module) {
    ...
    var decode2 = /* @__PURE__ */ __name(function(str, defaultDecoder, charset) {
...
var require_stringify = __commonJS({
  "node_modules/qs/lib/stringify.js"(exports, module) {
    ...
    var sentinel = {};
    var stringify2 = /* @__PURE__ */ __name(function stringify3(object, prefix, generateArrayPrefix, commaRoundTrip, allowEmptyArrays, strictNullHandling, skipNulls, encodeDotInKeys, encoder2, filter, sort, allowDots, serializeDate, format, formatter, encodeValuesOnly, charset, sideChannel) {
      var obj = object;
...
// .wrangler/tmp/bundle-8kqjVk/middleware-loader.entry.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();

// .wrangler/tmp/bundle-8kqjVk/middleware-insertion-facade.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
...
app.post("/api/auth/send-magic-link", async (c) => {
  ...
  const expiresAt = Math.floor(Date.now() / 1e3) + 15 * 60;
  ...
  if (c.env.RESEND_API_KEY && c.env.RESEND_API_KEY !== "dummy") {
    const res = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        from: "Broono <login@broono.gitlab.io>",
        // Update when domain verified
        to: email,
  ...
  return c.json({
    ...
    dev_link: !c.env.RESEND_API_KEY || c.env.RESEND_API_KEY === "dummy" ? magicLink : void 0
  });
});
app.post("/api/auth/verify", async (c) => {
  ...
  const authToken = await new SignJWT({ id: user.id, email: user.email, sub_status: user.subscription_status }).setProtectedHeader({ alg: "HS256" }).setIssuedAt().setExpirationTime("30d").sign(jwtSecret);
  return c.json({
    success: true,
    token: authToken,
    user
  ...
  try {
    switch (event.type) {
      ...
      case "customer.subscription.deleted": {
        ...
        await c.env.DB.prepare(
          "UPDATE users SET subscription_status = ? WHERE stripe_customer_id = ?"
        ).bind("free", subscription.customer).run();
        break;
      }
    }
  } catch (e) {
