...
export const paymentProducts: PaymentProduct[] = [
  {
    id: 'coin_pouch',
    type: 'consumable',
    displayName: 'Style Token Pack',
    description: 'Optional parent-approved tokens for cosmetic unlock testing.',
    localizedPrice: '$0.99',
    priceMicros: 990_000,
    currencyCode: 'USD',
    ...
    coinAmount: 500,
    bonusItemIds: [],
    badge: 'Cosmetic test pack',
  },
  {
    id: 'coin_vault',
    type: 'consumable',
    displayName: 'Studio Token Vault',
    description: 'Optional parent-approved token bundle for wardrobe testing.',
    localizedPrice: '$4.99',
    ...
    coinAmount: 3_200,
    bonusItemIds: [],
    badge: 'Large test pack',
  },
  {
    id: 'starter_bundle',
    type: 'non-consumable',
    displayName: 'Starter Studio',
    description: 'Launch cosmetics and style tokens for mocked entitlement tests.',
    localizedPrice: '$1.99',
  ...
  },
  {
    ...
    description: 'Monthly mocked pass for VIP closet entitlement testing.',
